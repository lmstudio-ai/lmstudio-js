...
/**
 * Alternative token option evaluated during sampling.
 *
 * @public
 */
...
/**
 * Token generated by the model with optional sampling alternatives.
 *
 * @public
 */
export interface LLMToken {
  ...
  logProb?: number;
  /**
   * All tokens considered during sampling, including the selected token
   */
