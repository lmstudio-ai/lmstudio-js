...
/**
 * Options to use with {@link LowLevelProcessingController#createContentBlock}.
 *
 * @public
 */
...
/**
 * Options to use with {@link LowLevelProcessingController#createCitationBlock}.
 *
 * @public
 */
...
/**
 * Options to use with {@link LowLevelProcessingController#requestConfirmToolCall}.
 *
 * @public
...
/**
 * Return type of {@link LowLevelProcessingController#requestConfirmToolCall}.
 *
 * @public
 * @deprecated [DEP-PLUGIN-PREDICTION-LOOP-HANDLER] Prediction loop handler support is still in
 * development. Stay tuned for updates.
...
/**
 * Internal low-level processing controller for handling prediction processes. Not intended for
 * public use.
 */
export class LowLevelProcessingController extends BaseController {
  /** @internal */
